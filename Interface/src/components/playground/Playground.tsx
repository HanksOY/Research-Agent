...
export default function Playground({
  ...
  const videoTileContent = useMemo(() => {
    ...
    return (
      <div className="flex flex-col w-full grow text-gray-950 rounded-sm border border-gray-800 relative" style={{ background: 'linear-gradient(to bottom, #1e3a5f, #0f1b2e)' }}>
        {content}
      </div>
    );
    ...
    <>
      ...
      >
        ...
        <PlaygroundTile
          ...
          childrenClassName="h-full grow items-start"
          style={{ background: 'linear-gradient(to bottom, #1e3a5f, #0f1b2e)' }}
        >
          {settingsTileContent}
        </PlaygroundTile>
      </div>
